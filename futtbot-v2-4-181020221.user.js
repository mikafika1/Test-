...
// @version     2.4
// @author      FUTTBOT
// @description FUT Trade Bot - FIFA 23 Ultimate Team auto buyer, bidder, sniper, trader & more
...
// @require     https://futtbot.com/wp-content/uploads/fut-trade-enhancer/discord.11.4.2.min.js
// @require     https://futtbot.com/wp-content/uploads/fut-trade-enhancer/fut-trade-enhancer-2-4-0.user.js?v240
// @require     https://futtbot.com/wp-content/uploads/fut-trade-enhancer/additional-files.user.js
// @updateURL   http://futtbot.com/
// @downloadURL http://futtbot.com/
// @noFrame
// ==/UserScript==
    ...
    (() => {
      ...
      n.r(e),
        n.d(e, {
          ...
          idAbCoins: () => ke,
          idAbCountDown: () => Tt,
          idAbCustomDiscordNameNotificationToggle: () => fe,
          idAbCycleAmount: () => Z,
          idAbDelayToAdd: () => ce,
          idAbDontMoveWon: () => $t,
          idAbDownloadFilter: () => ot,
          idAbDownloadStats: () => Bt,
          idAbFiltersFileToUpload: () => ft,
          ...
          idAbMessageNotificationToggle: () => me,
          ...
          idAbRequestCount: () => Ee,
          idAbResumeAfterErrorOccured: () => At,
          ...
          idClearLogButton: () => Pe,
          idDeleteFilter: () => Me,
          idDiscordChannelId: () => Se,
          idDiscordToken: () => we,
          idFUTMarketAlertToken: () => $e,
          idFilterDropdown: () => W,
          ...
          idTelegramChatId: () => ye,
          idTestNotification: () => xe,
          idTooltip: () => Dt,
          idWebHookUrl: () => Ft,
          idWinMp3: () => Ge,
        });
      var t = {};
      n.r(t), n.d(t, { startAutoBuyer: () => Hi, stopAutoBuyer: () => zi });
      const i = "Paused",
        s = "Stopped",
        o = {
      ...
      const qt = (e, t, n, i, s = !1) => {
        ...
        Yt = (
          ...
          return (
            t && (l && l(t), qt(d, s, t, o, !0)),
            Gt.has(d) ||
              ($(document).on(
                "input",
                `#${n[d]}`,
                ({ target: { value: e } }) => {
                  l && l(e), qt(d, s, e || t, o, !e);
                }
              ),
              Gt.add(d)),
      ...
      let Xt = new Set();
      const Kt = (e, t, n, i, s = "buyer-settings-field", o = null) => {
          ...
          return `<div style='display : none' class='buyer-settings-wrapper notification-settings-view'> \n ${
            l
              ...
              : `${Yt(
                  ...
                  "FUTTBOT Notification Token",
                  "",
                  { idFUTMarketAlertToken: $e },
                  "Your FUTTBOT App's Token",
                  "CommonSettings",
                  "text"
                )}\n  ${Kt(
            ...
            xe,
            "Test Notification",
            () => Vn("Test Notification Message", !0, !0),
            "call-to-action"
          )}\n   </div>\n  `;
        },
        ln = function () {
      ...
      const pn = function () {
          ...
          return (
            (function () {
              ...
              const e = `#${pt}`,
                t = $(
                  `\n            <div class="price-filter buyer-settings-field">\n              <div class="info">\n               <span class="secondary label">\n                  <button id=${Dt} style="font-size:16px" class="flat camel-case">Players List</button><br/>\n                </span>\n              </div>\n              <div class="ignore-players displayCenterFlx">\n                ${on(
                    ...
                    "+",
                    () => {
                      const t = `${un._playerNameInput.value}(${un.selected.rating})`,
                        n = dn(e, t);
                      if (
                        ...
                        n.push({ id: un.selected.id, displayName: t }),
              ...
              return (
                $(un.__root).insertBefore(t.find(`#${ct}`)),
                un.init(),
                un._playerNameInput.setPlaceholder("Search Players"),
                t
              );
            })().insertAfter(t),
            e
      ...
      const fn = (e) => {
          ...
          if (n.length) {
            ...
            (i = { filters: t }),
              (s = "filters"),
              l ? B(i, s) : I(i, s),
              Wn("Filters downloaded successfully");
          } else Wn("No filter selected", UINotificationType.NEGATIVE);
        },
        gn = () => {
          const e = $(`#${ft}`).prop("files");
          if (!e || !e[0])
            return void Wn(
          ...
          (n.onload = (e) => {
            ...
            if (t && t.filters) {
              for (let e in t.filters) En(e, t.filters[e]);
              Wn("Filters uploaded successfully");
            } else Wn("Not a valid filters file");
          }),
            n.readAsText(t);
        },
        bn = async () => {
          y("filters") || h("filters", (await f()) || {});
          let e = y("filters");
          return (
            (e = Object.keys(e)
              .sort()
      ...
      $(document).on({ change: cn, click: cn, touchend: cn }, `#${V}`);
      const hn = (e, t) => {
          let n = y(t);
          return (
            n
        ...
        vn = async function (e) {
          ...
          const i = $(
            `<div style="width:100%;display: flex;flex-direction: column;">\n            ${
              ...
              e
                ? ""
                : `<div id=${_t} style="margin-top: 1%;" class="button-container btn-filters"></div>`
            }\n             </div>`
          );
          return !e && wn.call(this, i, t), i;
        },
        wn = function (e, t) {
          const n = e.find(`#${_t}`),
            i = e.find(`#${Mt}`);
                ...
                () => {
                  mn(
                    [
                      ...
                      { labelEnum: atob("V2Vic2l0ZQ==") },
                    ],
                    atob("UmVwb3J0IGEgcHJvYmxlbQ=="),
                    atob(
                      "QmVsb3cgYXJlIHRoZSBsaXN0IG9mIHdheXMgdG8gcmVwb3J0IGEgcHJvYmxlbSA8YnIgLz4="
                    ),
                    (e) => {
                      e === atob("V2Vic2l0ZQ==")
                        ? window.open(
                            atob(
                              "aHR0cHM6Ly9mdXR0Ym90LmNvbQ=="
                            ),
                            atob("X2JsYW5r")
                          )
                        : e === atob("RGlzY29yZA==")
                        ? window.open(
                            atob(
                              "aHR0cHM6Ly9kaXNjb3JkLmNvbS9pbnZpdGUvRnFXenZzOUhaNg=="
                            ),
                            atob("X2JsYW5r")
                          )
                        : e === atob("VHdpdHRlcg==") &&
                          window.open(
                            atob("aHR0cHM6Ly90d2l0dGVyLmNvbS9mdXR0Ym90"),
                            atob("X2JsYW5r")
                          );
                    }
                  );
        ...
        Sn = new Map();
      let $n, An;
      Sn.set(0, { label: "Buy/Bid Settings", selector: ".buy-settings-view" }),
        Sn.set(1, { label: "Sell Settings", selector: ".sell-settings-view" }),
        Sn.set(2, {
      ...
      const Cn = function () {
          return (
            (An = new EAFilterBarView()),
            Sn.forEach((e, t) => {
              An.addTab(t, e.label);
            }),
            An.setActiveTab(0),
            An.layoutSubviews(),
            An.addTarget(this, xn, EventType.TAP),
            (An.__root.style = "margin-top: 20px;"),
            ($n = $(An.__root)),
            $n.find(".menu-container").css("overflow-x", "auto"),
            Pn(!0),
            An
          );
        },
        ...
        Pn = async function (e) {
          An.setActiveTab(0),
            $n.append(Qt.call(this)),
            $n.append(en.call(this)),
            $n.append(pn.call(this)),
            $n.append(tn.call(this));
          const t = await yn.call(this);
          $n.append(t),
            $n.append(nn.call(this)),
            $n.append(an.call(this)),
            $n.append(ln.call(this)),
        ...
        xn = function (e, t, n) {
          _n();
          const i = Sn.get(n.index).selector;
          $(i).css("display", "");
        },
        _n = () => {
          Sn.forEach((e, t) => {
        ...
        Dn = () => {
          document.querySelectorAll(":invalid").length &&
            Wn(
              "Settings with invalid value found, fix these values for FUTTBOT to work as intended",
              UINotificationType.NEGATIVE
            );
        },
        Nn = `#${W}`,
        ...
        Rn = function (e) {
          ...
          setTimeout(function () {
            ...
            let r = $(`${Nn} option`).filter(":selected").val();
            ...
            if ((Dn(), a)) {
              ...
              En(a, s),
                ...
                Wn("Changes saved successfully");
            } else $(t).removeClass("active"), Wn("Filter Name Required", UINotificationType.NEGATIVE);
          }, 200);
        },
        En = (e, t) => {
          (e = e.toUpperCase()),
            dn(Nn, e),
            dn(`#${V}`, e),
            $(`${Nn} option[value="${e}"]`).attr("selected", !0),
        ...
        Un = async function () {
          const e = $(`${Nn} option`).filter(":selected").val();
          ...
          "Choose filter to load" != e &&
            ($(`${Nn} option[value="${e}"]`).remove(),
            $(`${Nn}`).prop("selectedIndex", 0),
            await Tn(),
            this.viewDidAppear(),
            delete y("filters")[e],
            $(`${Fn} option[value="${e}"]`).remove(),
            cn(),
            ((e) => {
              u(e);
            })(e),
      ...
      const Wn = function (e, t) {
        ...
        Vn = (e, t, n) => {
          const i = v();
          (i.idAbMessageNotificationToggle || n) &&
            (l ? Hn(e) : Jn(i, t, e), n && Wn("Test Notification Sent"));
        },
        Hn = (e) => {
          window.ReactNativeWebView.postMessage(
        ...
        zn = (e, t, n) => {
          let i = {
            embeds: [
              {
                description: e,
                color: t ? 2555648 : 16711680,
                footer: {
                  text: `FUTTBOT Alert - ${new Date().toLocaleTimeString()}`,
                  icon_url:
                    "https://futtbot.com/wp-content/uploads/2020/11/futtbot-logo-simple-150.png",
                },
              },
            ],
            avatar_url:
              "https://futtbot.com/wp-content/uploads/2020/11/futtbot-logo-simple-150.png",
            username: "FUTTBOT Alert",
          };
          return n && delete i.username, i;
        },
        jn = (e) => {
          const {
            embeds: [t],
        ...
        Jn = (e, t, n) => {
          const i = e.idTelegramBotToken,
            s = e.idTelegramChatId,
            o = e.idWebHookUrl,
            r = e.idDiscordChannelId,
            a = e.idFUTMarketAlertToken,
            l = e.idAbCustomDiscordNameNotificationToggle;
          Gn(i, s, n), Yn(r, t, n, l), qn(o, t, n, l), Kn(a, n);
        },
        Gn = (e, t, n) => {
          if (e && t) {
        ...
        qn = (e, t, n, i) => {
          e &&
            fetch(e, {
              ...
              body: JSON.stringify(zn(n, t, i)),
            });
        },
        Yn = (e, t, n, i) => {
          if (e)
            if (Ln) {
              const s = Ln.channels.get(e);
              s && s.send(jn(zn(n, t, i)));
            } else
              Ln = Xn(() => {
                setTimeout(() => {
                  if (Ln) {
              ...
              n.on("message", async function (e) {
                if (e.author.id != n.user.id)
                  if (/start/i.test(e.content)) {
                    ...
                    Hi.call(t),
                      e.channel.send(jn(zn("Bot started successfully", !0)));
                  } else if (/stop/i.test(e.content))
                    zi(),
                      e.channel.send(jn(zn("Bot stopped successfully", !0)));
                  else if (/runfilter/i.test(e.content)) {
                    let t = e.content.split("-")[1];
                    if (t) {
                      (t = t.toUpperCase()), zi(), h("selectedFilters", []);
                      const n = y("AutoBuyerInstance");
                      if (!(await kn.call(n, t)))
                        return void e.channel.send(
                          jn(zn(`unable to find filter${t}`, !1))
                        );
                      Hi.call(n),
                        e.channel.send(jn(zn(`${t} started successfully`, !0)));
                    } else
                      e.channel.send(jn(zn("Unable to find filter name", !1)));
                  }
              });
          } catch (e) {}
          return n;
        ...
        Qn = function (e) {
          Vn(
            ...
            e
              ...
              : Zn("[!!!] Autostopping bot since Captcha got triggered", Ae);
        },
        Zn = function (e, t) {
          setTimeout(() => {
            var n = $("#" + t);
      ...
      const oi = function (e) {
          ...
          const t = 1e3 * _(e.idAbPauseFor);
          si = si || M(e.idAbCycleAmount);
          ...
          return !n || (n - i) % si
            ...
            : (Ht("previousPause", n),
              ...
              zi(!0),
              setTimeout(() => {
                (si = M(e.idAbCycleAmount)), Hi.call(this, !0);
              }, t));
        },
        ri = async function () {
          ...
          if (!e || !e.length || t > n) return w("currentFilterCount"), !1;
          ...
          let o = e[s];
          return await kn.call(this, o), Zn(`Running for filter ${o}`, Ae), !0;
        },
        ai = async (e) => {
          l ? li(e) : di(e);
        },
        ...
        mi = async (e) => {
          ...
          if (n.size) for (const e of n.values()) i.push(ui(e, t));
        ...
        gi = new Set(["Position", "Chemistry Style"]),
        bi = async (e, t) => {
        ...
        yi = async (e) => {
          ...
          for (const s of e) {
            ...
            e
              ...
              : s.isTraining() &&
                gi.has(s._staticData.name) &&
                (i.has(s._staticData.name) || i.set(s._staticData.name, []),
                i
                  .get(s._staticData.name)
                  .push({ definitionId: s.definitionId, subType: fi(s) }));
          }
          const s = [];
          return (
            n.size && s.push(bi(n, t)),
            i.size && s.push(hi(i, t)),
            await Promise.all(s),
            t
          );
        },
        vi = async (e) => {
          const t = S();
          return "FUTWIZ" === t ? mi(e) : "FUTBIN" === t ? yi(e) : void 0;
        },
        wi = (e) => {
          let t = JSUtils.find(
            ...
            if (r && r.price) {
              ...
              await Ci(n),
                n.hasPriceLimits() &&
                  ...
                  a === n._itemPriceLimits.minimum && (a = $i(a))),
                (a = wi(a)),
                Zn(
                ...
                (i = a);
            } else (i = null), Zn(`= Unable to get ${o} price for ${t}`, Ae);
          } catch (e) {
      ...
      const Pi = new Map(),
              ...
              if (c.success) {
                ...
                if (s) {
                  ...
                  if (
                    ...
                    Zn(`W: ${s} ${t} buy success added to sell queue`, Ae),
                    !a.idAbDontMoveWon)
                  ) {
                    const n = y("sellQueue") || [];
                    n.push({
                ...
                if (
                  ...
                  ("L" !== p && "A" !== p) ||
                    Vn("| " + t.trim() + " | " + u.trim() + " | failure |", !1),
                  a.idAbStopErrorCode)
                ) {
                  const e = new Set(a.idAbStopErrorCode.split(","));
                  if (
                    (Pi.has(i) || Pi.set(i, { currentVal: 0 }),
                    Pi.get(i).currentVal++,
                    e.has(i) &&
                      Pi.get(i).currentVal >= a.idAbStopErrorCodeCount &&
                      (Zn(
                    ...
                    const e = _(a.idAbResumeAfterErrorOccured);
                    Zn(`Bot will resume after ${e}(s)`, Ae),
                      setTimeout(() => {
                        Hi.call(y("AutoBuyerInstance"));
                      }, 1e3 * e);
                  }
                }
              }
                          ...
                          async function (n, i) {
                            ...
                            if (
                              ...
                              for (var u = 0; u < t.length; u++) {
                                ...
                                r && c && (o = await Ai(e, a, n));
                                e.idSellCheckBuyPrice &&
                                  l > (95 * o) / 100 &&
                                  (o = -1);
                                const d = o && !isNaN(o) && r;
                                if (
                                  (d && xi.add(n._auction.tradeId),
                                  !e.idAbDontMoveWon)
                                ) {
                                  const e = y("sellQueue") || [],
                                    t = 0.95 * o - l;
        ...
        Mi = async (e, t, n, i) => {
          ...
          let d = i.idAbBidExact ? t : o ? Si(t) : t,
            c = i.idAbBidExact ? t : o ? $i(r) : r;
          l &&
            r <= d &&
            (Zn("Bidding on outbidded item -> Bidding Price :" + c, Ae),
            await Ii(e, a, c, n),
        ...
        Di = () => {
          ...
          if (!n || !i || !t)
            return (
              Zn("Proxy info not filled properly", Ae),
              void Qn(e.idAbCloseTabToggle)
            );
          function r(e) {
        ...
        Fi = function (e) {
          return new Promise((t) => {
            ...
            if (!c && !d && !u)
              return Zn("skip search >>> (No Buy or Bid Price given)", Ae), t();
            On("Transfer Market Search"),
              (() => {
                const e = y("sessionStats");
                e.searchCount++, e.searchPerMinuteCount++, h("sessionStats", e);
              })();
            let p = this._viewmodel.searchCriteria;
            i && (p.minBid = wi(F(0, e.idAbRandMinBidInput))),
              s && (p.minBuy = wi(F(0, e.idAbRandMinBuyInput))),
              services.Item.clearTransferMarketCache(),
                  ...
                  if (s.success) {
                    ...
                    Zn(
                      ...
                      s.data.items.length > 0 &&
                        (Zn("--------------------", Ae),
                        1 === r && On("Transfer Market Results - List View"),
                        u &&
                          "player" === s.data.items[0].type &&
                          (await vi(s.data.items))),
                    ...
                    for (
                      ...
                      if (u && "player" === h) {
                        ...
                        if (!t || !t.price) {
                          Zn(`Price unavailable for ${p._staticData.name}`, Ae);
                          continue;
                        }
                        {
                          const n = wi((t.price * o) / 100);
                          (c = n), e.idAbBidFutBin && (d = n);
                        }
                      }
                      let S = g.buyNowPrice,
                        $ = g.currentBid || g.startingBid,
                        A = g.currentBid,
                        C = e.idAbBidExact ? d : A ? Si(d) : d,
                        T = e.idAbBidExact ? C : A ? $i($) : $,
                        B = e.idAbSellPrice,
                        P = e.idAbMinRating,
                        I = e.idAbMaxRating,
                        x = p._staticData.name;
                      const _ = !(P || I) || ((f = I), (m = w) >= P && m <= f),
                        M = Ri(`${x}(${w}) Price: ${S} time: ${b}`);
                      if (
                      ...
                      if ((!d && D < S) || (d && D < T))
                        ...
                        M("attempt bid: " + T),
                          Ni.add(g.tradeId),
                          i--,
                          await Ii(p, x, T, B, T === S, g.tradeId);
                      } else
                        M(
                          (c && S > c) || (d && $ > C)
                            ? `BuyPrice: ${
              ...
              n || repositories.Item.isDirty(ItemPile.TRANSFER)
                ? services.Item.requestTransferItems().observe(
                    ...
                    async function (n, s) {
                      ...
                      zt("soldItems") < o && (await ni()), Ht("soldItems", o);
                      ...
                      Ht("coinsNumber", c),
                        Ht("coins", c.toLocaleString()),
                        a &&
                          (Zn("[TRANSFER-LIST] > " + o + " item(s) sold\n", Ae),
        ...
        ki = function () {
          return {
            switchFilterWithContext: ri.bind(this),
            srchTmWithContext: Fi.bind(this),
            watchListWithContext: _i.bind(this),
            transferListWithContext: Ei.bind(this),
            pauseBotWithContext: oi.bind(this),
          };
        },
        Ui = async () => {
          const e = y("sellQueue") || [],
          ...
          for (i && Zn("--------------------", Ae); e.length; ) {
            const {
              ...
              l = await Wi(i, s, a, o, t);
            Li(s, o, a, t, r, l, n), e.length && (await T(2));
          }
          i && Zn("--------------------", Ae);
        },
        Li = (e, t, n, i, s, o, r) => {
      ...
      const Hi = async function (e) {
          ...
          if (y("autoBuyerActive")) return;
          ((e) => {
            Wn(e ? "FUTTBOT Resumed" : "FUTTBOT Started"),
              h("autoBuyerActive", !0),
            ...
            (Oi = ((e, t, n) => {
              ...
              (Vi = o(r)),
                ((e) => {
                  ...
                  let s = ii || _(e.idAbStopAfter);
                  ii || (ii = s);
                  let o = (new Date().getTime() - i) / 1e3 >= s;
                  (o || (n && t >= n)) &&
                    (Zn(
                      "FUTTBOT stopped | " +
                        (o ? "Time elapsed" : "Max purchases count reached"),
                      Ae
                    ),
                    (ii = null),
                    (si = null),
        ...
        zi = (e) => {
          Oi && Oi.clear(), !e && Vi && clearTimeout(Vi);
          ...
          h("searchInterval", { start: n.start, end: Date.now() }),
            ...
            Wn(e ? "FUTTBOT Paused" : "FUTTBOT Stopped"),
            e || Ui(),
            $("#" + Ue)
              .css("color", "red")
              .html(e ? "PAUSED" : "IDLE");
        ...
        { startAutoBuyer: Gi, stopAutoBuyer: qi } = t,
        Yi = function (e) {
          UTMarketSearchFiltersViewController.call(this);
        },
        Xi = UTMarketSearchFiltersViewController.prototype.init,
        Ki = UTMarketSearchFiltersViewController.prototype.viewDidAppear;
      JSUtils.inherits(Yi, UTMarketSearchFiltersViewController),
        JSUtils.inherits(
        ...
        (Yi.prototype.init = function () {
          ...
          const t = Cn.call(this);
          let n = $(e.__root);
          const i = jt.bind(this),
            s = i("Stop", () => qi.call(this)),
            o = i("Clear Log", () => ei.call(this), "btn-other"),
            r = i(
              "Start",
              () => {
                Gi.call(this),
          ...
          l.on("click touchend", async function () {
            $(`#${W}`).prop("selectedIndex", 0), await Tn();
          }),
        ...
        (Yi.prototype.viewDidAppear = function () {
      ...
      const Qi = function (e) {
        ...
        n.find(".filter-place").length ||
          vn.call(this, e).then((e) => {
            n.find(".ut-item-search-view").first().prepend(e);
          });
      };
      Yi.prototype.getNavigationTitle = function () {
        return (
          setTimeout(() => {
            const e = $(".title");
                  ...
                  const e = $(
                    `<div style=${
                      isPhone()
                        ...
                        : "width:48%"
                    } id=${Et}>\n            <div class="logs-container">\n              <label>Logs:</label>\n              <div data-title="Clear logs" class="button-clear">\n              </div>\n            </div>\n            <br/>\n            <div class="logWrapper">\n              <textarea wrap="off"  style="height: 100%;overflow-x: auto;resize: none; width: 100%;" readonly id=${Ae} class="autoBuyerLog"></textarea>\n              <a class="joinServer" target="_blank" rel="noopener noreferrer" href="https://discord.gg/FqWzvs9HZ6">Join Our Discord Server</a>\n            <br/>\n        </div>`
                  );
                  return (
                    e.find(".button-clear").append(jt("⎚", () => ei()).__root),
                    e
                  );
                })()
              ),
      ...
      const Zi = () => {
          ...
          UTGameTabBarController.prototype.initWithViewControllers = function (
            ...
            n.initWithRootController(new Yi()),
              (n.tabBarItem = ts("FUTTBOT")),
              (t = es(t)).push(n),
              e.call(this, t);
          };
        },
